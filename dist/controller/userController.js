...
class UserController {
    ...
    registerUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return res.status(user === null || user === void 0 ? void 0 : user.statusCode).json(Object.assign({}, user));
            }
            catch (error) {
                console.log(error);
                next(error);
    ...
    activateUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(user === null || user === void 0 ? void 0 : user.statusCode).json(Object.assign({ message }, user));
            }
            catch (error) {
                console.log(error);
                next(error);
    ...
    resendOtp(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(user);
                res.status(user === null || user === void 0 ? void 0 : user.statusCode).json(Object.assign({ message: user.message }, user));
            }
            catch (error) {
                console.log(error);
                next(error);
    ...
    verifyEmailEditOtp(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const token = req.cookies.activationToken;
                const result = yield this.userCase.verifyEmailEditOtp(token, req.body.code);
                res.status(result.statusCode).json(Object.assign({}, result));
            }
            catch (error) {
                console.log(error);
    ...
    addReply(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(express_1.response.statusCode).json(Object.assign({}, reponse));
            }
            catch (error) {
                console.log(error);
                next(error);
    ...
    getLendedBooks(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.userCase.getLendedBooks(userId, Number(pageNo));
                res.status(result.statusCode).json(Object.assign({}, result));
            }
            catch (error) {
                console.log(error);
    ...
    getBorrowedBooks(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { userId, pageNo } = req.query;
                const result = yield this.userCase.getBorrowedBooks(userId, Number(pageNo));
                res.status(result.statusCode).json(Object.assign({}, result));
            }
            catch (error) {
                console.log(error);
    ...
    getNotifications(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.userCase.getNotifications(userId, Number(pageNo), Boolean(u));
                res.status(result.statusCode).json(Object.assign({}, result));
            }
            catch (error) {
                console.log(error);
    ...
    submitNewPasswordBeforeLogin(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.userCase.submitNewPasswordBeforeLogin(password, token);
                res.status(result.statusCode).json(Object.assign({}, result));
            }
            catch (error) {
                console.log(error);
    ...
    getOtpForChangePassAfterLogin(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.userCase.otpChangePassAfterLogin(userId, email);
                if (result.activationToken) {
    ...
    resendForChangePassAfterLogin(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.userCase.otpResendPassAfterLogin(changePassOtpCookie, userId);
            if (result.activationToken) {
                res.cookie('changePassOtpTokenAfterLogin', result.activationToken, {
                    maxAge: 2 * 60 * 1000,
                    httpOnly: true,
    ...
    submitChangePassOtpAfterLogin(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const changePassOtpCookie = req.cookies.changePassOtpTokenAfterLogin;
                const otp = req.body.otp;
                const result = yield this.userCase.submitChangePassOtpAfterLogin(changePassOtpCookie, otp);
                if (result.activationToken) {
