    ...
    verifyPayment(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.userCase.verifyPayment(orderId, paymentId, signature, userId);
                res.status(result.statusCode).json(Object.assign({}, result));
            }
            catch (error) {
                console.log(error);
    ...
    verifyAddFundsPayment(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.userCase.verifyaddFundsPayment(orderId, paymentId, signature, userId, Number(amount));
                res.status(result.statusCode).json(Object.assign({}, result));
            }
            catch (error) {
                console.log(error);
