...
function loadAllUsers() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            worker_threads_1.parentPort === null || worker_threads_1.parentPort === void 0 ? void 0 : worker_threads_1.parentPort.postMessage({ status: 'complete' });
        }
        catch (error) {
...
function updateBadge() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            worker_threads_1.parentPort === null || worker_threads_1.parentPort === void 0 ? void 0 : worker_threads_1.parentPort.postMessage({ status: 'updatebadgecomplete' });
        }
        catch (error) {
