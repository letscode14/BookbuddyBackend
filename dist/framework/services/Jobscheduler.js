...
class JobScheduler {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.agenda.define('removeStory', (job) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.agenda.define('requestExpiry', (job) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.agenda.define('updateRemainingDays', (job) => __awaiter(this, void 0, void 0, function* () {
                const { borrowId, lendedId } = job.attrs.data;
                const result = yield this.userRepository.updateRemainingDays(borrowId, lendedId);
            }));
            this.agenda.define('updateBadge', () => __awaiter(this, void 0, void 0, function* () {
