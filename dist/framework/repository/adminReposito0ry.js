...
class AdminRepository {
                ...
                switch (fetch) {
                    ...
                    case 'Blocked':
                        users = (yield userModel_1.default
                            ...
                            .limit(limit)
                            .skip(skip));
                        totalCount = yield userModel_1.default.countDocuments({ isBlocked: true });
                    ...
                    case 'Blocked':
                        users = (yield userModel_1.default
                            ...
                            .limit(limit)
                            .skip(skip));
                        totalCount = yield userModel_1.default.countDocuments({ isDeleted: true });
                        totalPages = Math.ceil(totalCount / limit);
                        return { users, totalPages };
                        break;
                }
    ...
    blockUser(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (action === 'Block') {
                    const blocked = yield userModel_1.default.findByIdAndUpdate(userId, { $set: { isBlocked: true } }, { new: true });
                    yield this.updateRedisBlockedUsers();
                    return true;
                }
                else if (action === 'Unblock') {
                    const unblocked = yield userModel_1.default.findByIdAndUpdate(userId, { $set: { isBlocked: false } }, { new: true });
                    yield this.updateRedisBlockedUsers();
                    return true;
                }
                return false;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const blockedUsers = yield userModel_1.default
                    ...
                    .select('_id')
                    .lean();
                yield redis_1.redis.set('blockedUsers', JSON.stringify(blockedUsers), 'EX', 3600);
            }
            catch (error) {
            ...
            try {
                ...
                switch (fetch) {
                    case 'all':
                        ...
                        posts = yield postModel_1.default.aggregate(pipeline).skip(skip).limit(limit);
                    ...
                    case 'Deleted':
                        ...
                        posts = yield postModel_1.default.aggregate(pipeline3).skip(skip).limit(limit);
                        totalCount = yield postModel_1.default.countDocuments({ isDeleted: true });
                        totalPage = Math.ceil(totalCount / limit);
                        return { post: posts, totalPage };
                    case 'Removed':
                        let pipeline4 = [
                        ...
                        posts = yield postModel_1.default.aggregate(pipeline4).skip(skip).limit(limit);
                        totalCount = yield postModel_1.default.countDocuments({ isRemoved: true });
                        totalPage = Math.ceil(totalCount / limit);
                        return { post: posts, totalPage };
                }
                return null;
    ...
    removeReport(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { rId } = req.body;
                const removeReport = yield reportsModel_1.default.findByIdAndUpdate(rId, {
                ...
                if (removeReport) {
                    if (removeReport.targetType == 'Borrowed') {
                        ...
                        if (result && result.borrowed && result.borrowed.length > 0) {
                            ...
                            }, { $pull: { reportCount: removeReport._id } }, { new: true });
                            if (user) {
                                return true;
                            }
                        }
                    ...
                    if ((removeReport === null || removeReport === void 0 ? void 0 : removeReport.targetType) == 'Post') {
    ...
    editBadge(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { badgeName, minScore, borrowLimit } = req.body;
                if (!badgeName || !minScore || !borrowLimit || !badgeId)
                    return null;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const user = (yield userModel_1.default.aggregate([
                    {
                        $match: { _id: new mongodb_1.ObjectId(userId === null || userId === void 0 ? void 0 : userId.toString()) },
                    },
                    {
                        $lookup: {
                            from: 'lendscores',
                ...
                const books = yield bookShelfModel_1.default.aggregate([
                    { $match: { userId: new mongodb_1.ObjectId(userId === null || userId === void 0 ? void 0 : userId.toString()) } },
                    {
                        $addFields: {
                ...
                const obj = {
                    ...
                    postLength: yield postModel_1.default.countDocuments({
                        userId: new mongodb_1.ObjectId(userId === null || userId === void 0 ? void 0 : userId.toString()),
                    }),
                    books: ((_a = books[0]) === null || _a === void 0 ? void 0 : _a.postLength) || 0,
                };
                return obj;
            }
            catch (error) {
            ...
            try {
                ...
                if (query == 'days') {
                    ...
                    stats = allMonths.map((month) => {
                        const monthKey = (0, moment_1.default)(month.month, 'MMMM YYYY').format('YYYY-MM');
    ...
    getPostStatistics() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const stats = {
                    totalPost: ((_a = results[0]) === null || _a === void 0 ? void 0 : _a.totalPost) || 0,
                    removedPost: ((_b = results[0]) === null || _b === void 0 ? void 0 : _b.removedPost) || 0,
                    reportedPost: ((_c = results[0]) === null || _c === void 0 ? void 0 : _c.reportedPost) || 0,
                    postAddedToBookshelf: ((_d = results[0]) === null || _d === void 0 ? void 0 : _d.postAddedToBookshelf) || 0,
                };
                return stats;
            }
            catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (post) {
                    ...
                    yield post.populate('comments.replies.author', 'userName profile name');
                    return post;
                }
                return null;
            }
    ...
    getPeriodTransactionStatistics(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter === 'days') {
                ...
                const transactionsPerDay = yield bookShelfModel_1.default.aggregate(pipeline);
                const result = [];
                let currentDate = new Date(start);
                while (currentDate < end) {
                    const dayOfMonth = currentDate.getDate();
                    const existingDay = transactionsPerDay.find((day) => day._id === dayOfMonth);
                    result.push({
            ...
            if (filter === 'months') {
                ...
                const transactionsPerMonth = yield bookShelfModel_1.default.aggregate(pipeline);
                const result = [];
            ...
            if (filter === 'years') {
                ...
                const transactionsPerYear = yield bookShelfModel_1.default.aggregate(pipeline);
                const result = [];
                let currentYear = startYear;
                while (currentYear <= new Date().getFullYear()) {
                    const existingYear = transactionsPerYear.find((y) => y._id === currentYear);
                    result.push({
                        year: currentYear,
            ...
            try {
                ...
                if (filter == 'days') {
                    ...
                    finalResults = results.map((result) => {
                        const stages = result.stages.reduce((acc, { stage, count }) => {
                            acc[stage] = count;
                            return acc;
                    ...
                    while (currentDate <= end) {
                        ...
                        const existingMonth = finalResults.find((month) => month.month === monthOfYear);
                        result.push({
                    ...
                    while (currentDate <= end) {
                        ...
                        const existingYear = finalResults.find((yearData) => yearData.year === year);
                        result.push({
                            year: year.toString(),
    ...
    getLendedSingleTransaction(lendId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const lended = yield bookShelfModel_1.default.findOne({ 'lended._id': new mongodb_1.ObjectId(lendId) }, { 'lended.$': 1 });
                const lendDoc = yield (lended === null || lended === void 0 ? void 0 : lended.populate('lended.0.requestId'));
                if (lendDoc) {
    ...
    getBook(bookId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const book = yield bookShelfModel_1.default.findOne({ 'shelf._id': new mongodb_1.ObjectId(bookId) }, { 'shelf.$': 1 });
                if (book) {
                    return book.shelf[0];
                }
                return null;
    ...
    reduceCautionDeposit(userId, amount, note, lendId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                }, { $push: { deductions: { amount: Number(amount), note: note } } }, { upsert: true, new: true });
                yield bookShelfModel_1.default.findOneAndUpdate({ 'lended._id': new mongodb_1.ObjectId(lendId) }, { $set: { 'lended.$.hasMadeRefund': true } });
                if (deduction && user) {
                    return true;
                }
                return false;
