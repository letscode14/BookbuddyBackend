...
class UserRepository {
    findByEmailAndUserId(id, email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = (yield userModel_1.default.findOne({ _id: new mongodb_1.ObjectId(id), email: email }, {
                    _id: 1,
                    email: 1,
                    isGoogleSignUp: 1,
                    cautionDeposit: 1,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const blockedUsers = (yield userModel_1.default
                    ...
                    .select('_id')
                    .lean());
                yield redis_1.redis.set(cacheKey, JSON.stringify(blockedUsers), 'EX', 86400);
                return blockedUsers;
            }
            catch (error) {
                console.log(error);
    ...
    createUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (savedUser) {
                    const { email, _id, role, profile, isDeleted, isSubscribed, isGoogleSignUp, name, userName, } = savedUser;
                    return {
                        email,
                        _id,
                        role,
    ...
    addPost(id, description, images, req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let bookshelf;
                if ((_a = req.body) === null || _a === void 0 ? void 0 : _a.addToBookshelf) {
                    const { author, ShelfDescription, bookName, limit, location, address, lng, lat, price, } = req.body;
                    bookshelf = yield bookShelfModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(id) }, {
                        $push: {
                            shelf: {
                                author: author,
                                bookName: bookName,
                ...
                const lastAddedBookId = (_b = bookshelf === null || bookshelf === void 0 ? void 0 : bookshelf.shelf[bookshelf.shelf.length - 1]) === null || _b === void 0 ? void 0 : _b._id;
                const savedPost = yield postModel_1.default.create({
                    userId: new mongodb_1.ObjectId(id),
                    description,
                    imageUrls: images,
                    isAddedToBookShelf: ((_c = req.body) === null || _c === void 0 ? void 0 : _c.addToBookshelf)
    ...
    fetchPostData(req, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const followingIds = user.following.map((following) => following.userId._id);
    ...
    likePost(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield postModel_1.default.findByIdAndUpdate(postId, {
                ...
                if (result) {
                    ...
                    const imageUrl = result.imageUrls.length > 0 ? result.imageUrls[0].secure_url : null;
                    const latestLike = result.likes.length > 0 ? result.likes[result.likes.length - 1] : null;
                    ...
                    if (postOwner.toString() !== userId) {
                        const notification = yield this.createNotification(postOwner.toString(), message, 'Post', userId, postId);
                        return { notification };
                    }
                    else {
                        return { notification: {} };
    ...
    updateUserDetails(req, cloudRes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { age, contact, newAdded, email, gender, name, privacy, userName, userId, profileUrl, publicId, } = req.body;
                const defualt = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png';
                let profile;
                if (newAdded == 'true') {
                    profile = {
                ...
                const updatedUser = yield userModel_1.default
                    ...
                    .select('-password -followers -following');
                if (updatedUser) {
                    redis_1.redis.set(`user:${updatedUser._id}`, JSON.stringify(updatedUser));
                    return true;
                }
                return null;
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const post = yield postModel_1.default
                    .findOne({ _id: new mongodb_1.ObjectId(postId === null || postId === void 0 ? void 0 : postId.toString()), isRemoved: false })
                    .populate('likes', 'userName')
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const post = (yield postModel_1.default.findByIdAndUpdate(postId, {
                    $push: {
                        comments: { author: new mongodb_1.ObjectId(userId), content: comment },
                    },
                }, { new: true }));
                if (post) {
                    yield post.populate('comments.author', 'userName profile isSubscribed');
                    const newComment = post.comments[post.comments.length - 1];
                    const user = post.comments[0].toObject();
                    const message = `${user.author.userName} commented on your post .${comment}`;
                    yield this.createNotification(post.userId.toString(), message, 'Post', userId, postId);
                    return newComment;
                }
                else {
                    return null;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (post) {
                    ...
                    const newReply = updatedComment === null || updatedComment === void 0 ? void 0 : updatedComment.replies[updatedComment.replies.length - 1];
                    if (newReply && newReply.author && 'userName' in newReply.author) {
                        ...
                        yield this.createNotification(authorId, Replymessage, 'Post', userId, postId);
                    }
                    return newReply;
                }
                return null;
    ...
    getF(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                data === null || data === void 0 ? void 0 : data.followers.map((followers) => {
                    followersMapCurrent[followers.userId.toString()] = true;
                });
                const followingMap = {};
                data === null || data === void 0 ? void 0 : data.following.map((following) => {
                    followingMap[following.userId.toString()] = true;
                });
                let response;
                if (query == 'followers') {
                    ...
                    response.totalCount = Math.ceil((response === null || response === void 0 ? void 0 : response.totalCount) / limit);
    ...
    postReport(req, images) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { culprit, type, contentId, reportedBy, reason, bookAmount } = req.body;
                ...
                if (type == 'Post') {
                    yield postModel_1.default.updateOne({ _id: contentId }, { $inc: { reportCount: 1 } });
                }
                ...
                if (type === 'Lended') {
                    yield bookShelfModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(reportedBy), 'lended._id': contentId }, { $push: { 'lended.$.reportsMade': reported._id } }, { new: true });
                }
                if (type == 'Borrowed') {
                    yield bookShelfModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(reportedBy), 'borrowed._id': contentId }, { $push: { 'borrowed.$.reportsMade': reported._id } }, { new: true });
                }
                if (reported) {
    ...
    editBook(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { bookName, author, description, location, limit, ID, userId, _id, } = req.body;
    ...
    removeBook(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updatedBookshelf = yield bookShelfModel_1.default.findOneAndUpdate({
                    userId: new mongodb_1.ObjectId(userId),
                ...
                const updatedPost = yield postModel_1.default.findOneAndUpdate({
                    ...
                    userId: new mongodb_1.ObjectId(userId),
                }, { $set: { isAddedToBookShelf: null } }, { new: true });
    ...
    makeUserSubscribed(userId, paymentId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const badge = yield badgeModel_1.default.findOne({ minScore: { $gte: 10 } });
                if (badge) {
    ...
    getChat(senderId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (chat) {
                    yield messageModel_1.default.updateMany({ chatId: new mongodb_1.ObjectId(chat._id), senderId: new mongodb_1.ObjectId(userId) }, { $set: { status: true } });
                    return chat;
                }
                else {
                    ...
                    if (partChat) {
                        const updatedChat = yield chatModel_1.default.findOneAndUpdate({
                            participants: { $all: [senderId, userId] },
                        }, { $push: { sender: new mongodb_1.ObjectId(senderId) } }, { new: true }).populate('participants', 'userName profile name isSubscribed');
                        return updatedChat;
                    }
                    else {
                        const newChat = yield chatModel_1.default.create({
                            participants: [new mongodb_1.ObjectId(senderId), new mongodb_1.ObjectId(userId)],
                        ...
                        yield newChat.populate('participants', 'userName profile name isSubscribed');
                        return newChat;
                    }
                }
            }
    ...
    getAllChat(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (chats) {
                    const chatIds = yield Promise.all(chats.map((c) => __awaiter(this, void 0, void 0, function* () {
                        var _a;
                        if (((_a = c.lastMessage.messageId) === null || _a === void 0 ? void 0 : _a.type) == 'request') {
                    ...
                    chats.forEach((chat) => {
                        var _a, _b;
                        const unReadMessages = unReadMesg.filter((m) => m.chatId !== undefined &&
                            m.chatId.toString() == chat._id.toString());
                        if (((_a = unReadMessages[unReadMessages.length - 1]) === null || _a === void 0 ? void 0 : _a.type) == 'request') {
                            ...
                            messageMap[chat._id.toString()] = {
                                mCount: unReadMessages.length || 0,
                                content: ((_b = unReadMessages[unReadMessages.length - 1]) === null || _b === void 0 ? void 0 : _b.content) || '',
                            };
                        }
                    });
                    return {
    ...
    createMessage(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (chat) {
                    const receiver = chat === null || chat === void 0 ? void 0 : chat.participants.find((participant) => participant.toString() !== senderId);
            ...
            try {
                ...
                if (oldNotification) {
                    const notification = yield notificationModel_1.default.findOneAndUpdate({
                        ...
                        contentId: new mongodb_1.ObjectId(contentId),
                        actionBy: new mongodb_1.ObjectId(actionBy),
                    }, { $set: { createdAt: new Date() } }, { new: true });
                    if (notification) {
                        const modelName = notification.type === 'Post'
                            ? 'Post'
                            : notification.type == 'User'
                                ...
                                : notification.type == 'Request'
                                    ? 'Requests'
                                    : '';
                        const selectFields = notification.type == 'Post'
                            ? 'imageUrls'
                            : notification.type == 'User'
                                ? 'userName profile'
                                : notification.type == 'Request'
    ...
    makeMsgRead(messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const updatedMsg = yield messageModel_1.default.findByIdAndUpdate(messageId, {
                    $set: { status: true },
                }, { new: true });
                if (updatedMsg) {
                    return true;
    ...
    makeRequest(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = (yield userModel_1.default
                    .findOne({
                    _id: new mongodb_1.ObjectId(userId === null || userId === void 0 ? void 0 : userId.toString()),
                })
                    .populate('lendscore')
                ...
                if (user.isSubscribed && user.cautionDeposit < 50) {
                    return {
                        status: false,
                        message: 'Your caution deposit have exceeded please do the payment for further actions',
                    };
                }
                const bookshelf = yield bookShelfModel_1.default.findOne({
                    userId: new mongodb_1.ObjectId(ownerId === null || ownerId === void 0 ? void 0 : ownerId.toString()),
                    'shelf._id': new mongodb_1.ObjectId(bookId === null || bookId === void 0 ? void 0 : bookId.toString()),
                });
                let book;
                if (bookshelf === null || bookshelf === void 0 ? void 0 : bookshelf.isRestricted) {
                    return {
                        status: false,
                ...
                if (bookshelf) {
                    ...
                    if ((book === null || book === void 0 ? void 0 : book.status) !== 'Available') {
                        return {
                            status: false,
                ...
                const request = yield requestModel_1.default.findOne({
                    'book._id': new mongodb_1.ObjectId(bookId === null || bookId === void 0 ? void 0 : bookId.toString()),
                ...
                const newRequest = yield requestModel_1.default.create({
                    madeBy: new mongodb_1.ObjectId(userId === null || userId === void 0 ? void 0 : userId.toString()),
                    book: book,
                ...
                if (newRequest) {
                    ...
                    const notification = yield this.createNotification(ownerId, message, 'Requests', userId, newRequest._id);
                    ...
                    if (chat) {
                        return {
                            ...
                            requestedUser: {
                                ...
                                profileUrl: user === null || user === void 0 ? void 0 : user.profile,
                                requestId: newRequest._id.toString(),
                        ...
                        const newChat = yield chatModel_1.default.create({
                            participants: [new mongodb_1.ObjectId(userId), new mongodb_1.ObjectId(ownerId)],
                            sender: [new mongodb_1.ObjectId(userId), new mongodb_1.ObjectId(ownerId)],
                            isDeleted: false,
                        });
                        return {
                            status: true,
    ...
    declineRequest(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield requestModel_1.default.findByIdAndUpdate(requestId, {
                ...
                if (newMessage) {
                    ...
                    yield chatModel_1.default.findByIdAndUpdate(chatId, {
                        $set: {
                            'lastMessage.messageId': new mongodb_1.ObjectId(newMessage === null || newMessage === void 0 ? void 0 : newMessage._id),
                    ...
                    if (request) {
                        const notification = yield this.createNotification(request === null || request === void 0 ? void 0 : request.madeBy.toString(), message, 'Requests', senderId, request._id.toString());
                        const io = (0, socketService_1.getIO)();
                        if (io) {
    ...
    makeRequestExpirey(requestId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const updatedRequets = yield requestModel_1.default.findByIdAndUpdate(requestId, {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const reqUser = yield userModel_1.default
                    ...
                    .select('-password -following -followers -reportsMade -reportCount');
                if (!(reqUser === null || reqUser === void 0 ? void 0 : reqUser.isSubscribed)) {
                    return {
                        status: false,
                        message: 'This user is not verified',
                    };
                }
                if ((reqUser === null || reqUser === void 0 ? void 0 : reqUser.isSubscribed) && reqUser.cautionDeposit < 50) {
                    return {
                        status: false,
                ...
                if ((request === null || request === void 0 ? void 0 : request.stage) !== 'requested') {
                    return {
                        status: false,
                ...
                const b = bookshelf === null || bookshelf === void 0 ? void 0 : bookshelf.shelf.find((book) => book && book._id.toString() == _id);
                ...
                if (b === null || b === void 0 ? void 0 : b.isRemoved) {
                    return {
                        status: false,
                        message: 'This book has removed by our team please contact admin for futher ',
                    };
                }
                const lendScore = yield lendScoreModel_1.default.findOne({
                    userId: new mongodb_1.ObjectId(userId),
                }).populate('badgeId');
                if (lendScore) {
                    const { limit } = lendScore === null || lendScore === void 0 ? void 0 : lendScore.badgeId;
                    if ((lendScore === null || lendScore === void 0 ? void 0 : lendScore.totalBooksLended) >= limit) {
                        return {
                            status: false,
                ...
                try {
                    ...
                    const borrowed = yield bookShelfModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(requestedUser) }, {
                        $push: {
                            borrowed: {
                    ...
                    const lendeded = yield bookShelfModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(userId) }, {
                        $push: {
                            lended: {
                                requestId: new mongodb_1.ObjectId(requestId),
                    ...
                    yield bookShelfModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(userId), 'shelf._id': new mongodb_1.ObjectId(_id) }, {
                        $set: {
                            'shelf.$.status': 'Lended',
                        },
                    }, { upsert: true, session });
                    yield lendScoreModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(userId) }, { $inc: { totalBooksLended: 1, lendScore: 10 } }, { session, new: true });
                    yield lendScoreModel_1.default.findOneAndUpdate({ userId: new mongodb_1.ObjectId(requestedUser) }, { $inc: { totalBooksBorrowed: 1 } }, { session });
                    yield requestModel_1.default.findByIdAndUpdate(requestId, { $set: { stage: 'approved', isAccepted: true } }, { session });
                    ...
                    if (newMessage) {
                        ...
                        yield chatModel_1.default.findByIdAndUpdate(chatId, {
                            $set: {
                                'lastMessage.messageId': new mongodb_1.ObjectId(newMessage._id),
                                'lastMessage.timeStamp': new Date().getTime(),
                            },
                        }, { session });
                    }
                    ...
                    const notification = yield this.createNotification(requestedUser, message, 'Requests', userId, requestId);
                    const io = (0, socketService_1.getIO)();
                    if (io) {
                    ...
                    yield agenda_1.default.every('*/20 * * * * *', 'updateRemainingDays', {
    ...
    updateRemainingDays(borrowId, lendedId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const lendedDoc = yield bookShelfModel_1.default.findOne({ 'lended._id': new mongodb_1.ObjectId(lendedId) }, { 'lended.$': 1, userId: 1 });
                if (lendedDoc && lendedDoc.lended && lendedDoc.lended.length > 0) {
                    ...
                    if (lended.remainingDays === 2) {
                        ...
                        const notification = yield this.createNotification(lended.lendedTo.toString(), message, 'Requests', lendedDoc.userId.toString(), lended.requestId.toString());
                        const io = (0, socketService_1.getIO)();
                        if (io)
                            io.to(lended.lendedTo.toString()).emit('newnotification', {
                                notification,
                            });
                        console.log(`Lended document with ID ${lendedId} has only 2 days remaining.`);
                    }
                        ...
                        const request = yield requestModel_1.default.findByIdAndUpdate(lended.requestId, { $set: { isPending: false } });
                        const newRequest = yield requestModel_1.default.create({
                            madeBy: new mongodb_1.ObjectId(request === null || request === void 0 ? void 0 : request.madeBy),
                            book: request === null || request === void 0 ? void 0 : request.book,
                            expiresAt: request === null || request === void 0 ? void 0 : request.expiresAt,
                            stage: 'times up',
                            isAccepted: true,
                            isCancelled: false,
                        });
                        const user = yield bookShelfModel_1.default.findOneAndUpdate({ 'lended._id': new mongodb_1.ObjectId(lendedId) }, { $set: { 'lended.$.requestId': new mongodb_1.ObjectId(newRequest._id) } }, { new: true, projection: { userId: 1 } });
                        yield bookShelfModel_1.default.updateOne({
                            'borrowed._id': new mongodb_1.ObjectId(borrowId),
                        }, { $set: { 'borrowed.$.requestId': new mongodb_1.ObjectId(newRequest._id) } });
                        const chatId = yield chatModel_1.default.findOne({
                            participants: {
                                $all: [
                                    new mongodb_1.ObjectId(user === null || user === void 0 ? void 0 : user.userId.toString()),
                                    new mongodb_1.ObjectId(request === null || request === void 0 ? void 0 : request.madeBy.toString()),
                                ],
                            },
                        });
                        const newMessage = yield messageModel_1.default.create({
                            type: 'request',
                            chatId: new mongodb_1.ObjectId(chatId === null || chatId === void 0 ? void 0 : chatId._id),
                            senderId: new mongodb_1.ObjectId(user === null || user === void 0 ? void 0 : user.userId.toString()),
                            content: new mongodb_1.ObjectId(newRequest === null || newRequest === void 0 ? void 0 : newRequest._id),
                        });
                        if (newMessage) {
                            yield newMessage.populate('chatId', 'participants senderId');
                            yield newMessage.populate('senderId', 'userName profile');
                            ...
                            const notification = yield this.createNotification(newRequest.madeBy.toString(), message, 'Requests', (user === null || user === void 0 ? void 0 : user.userId) ? user === null || user === void 0 ? void 0 : user.userId.toString() : '', newRequest._id);
                            const io = (0, socketService_1.getIO)();
                            if (io) {
                                io.to(newRequest.madeBy.toString()).emit('message recieved', newMessage);
                                io.to(newRequest.madeBy.toString()).emit('newnotification', {
                                    notification,
                                });
                            }
                            console.log(`Lended document with ID ${lendedId} has reached zero days. Time up.`);
                        }
                    }
                }
                return {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (unRead) {
                    ...
                    yield notificationModel_1.default.updateMany({ ownerId: new mongodb_1.ObjectId(userId) }, { read: true });
                        ...
                        const selectFields = notification.type === 'Post'
                            ...
                            : notification.type == 'User'
                                ...
                                : notification.type == 'Requests'
                                    ? ''
                                    : 'text';
                        const model = notification.type == 'Post'
                            ? 'Post'
                            : notification.type == 'User'
                                ? 'User'
                                : notification.type == 'Requests'
    ...
    giveBookBack(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const chatId = yield chatModel_1.default.findOne({
                    participants: { $all: [new mongodb_1.ObjectId(userId), new mongodb_1.ObjectId(sendTo)] },
                });
                const newMessage = yield messageModel_1.default.create({
                    type: 'request',
                    chatId: new mongodb_1.ObjectId(chatId === null || chatId === void 0 ? void 0 : chatId._id),
                    senderId: new mongodb_1.ObjectId(userId),
                    content: new mongodb_1.ObjectId(newCollectRequest === null || newCollectRequest === void 0 ? void 0 : newCollectRequest._id),
                });
                if (newMessage) {
                    yield newMessage.populate('chatId', 'participants senderId');
                    yield newMessage.populate('senderId', 'userName profile');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (request) {
                    ...
                    try {
                        session.startTransaction();
                        const ownerBookShelf = yield bookShelfModel_1.default.findOneAndUpdate({
                            'lended.requestId': new mongodb_1.ObjectId(requestId),
                        ...
                        const requestedUserShelf = yield bookShelfModel_1.default.findOneAndUpdate({
                            userId: new mongodb_1.ObjectId(requestedUser),
                            'borrowed.requestId': new mongodb_1.ObjectId(request._id),
                        }, { $set: { 'borrowed.$.isReturned': true } }, { session });
                        const createdMessages = yield messageModel_1.default.create([
                            {
                                type: 'request',
                                chatId: new mongodb_1.ObjectId(chatId),
    ...
    exploreBooks(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (user) {
                    const followingUserIds = user.following.map((followingUser) => followingUser.userId.toString());
                    const followerUserIds = user.followers.map((followerUser) => followerUser.userId.toString());
                    const allUserIds = [
    ...
    changePassWord(password, email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = (yield userModel_1.default.findOneAndUpdate({ email: email }, { $set: { password: hashedPassword } }, { new: true, projection: { username: 1, _id: 0 } }));
                if (user) {
                    return user;
                }
                return null;
    ...
    getDeposit(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield userModel_1.default.findById(userId, { cautionDeposit: 1 });
                ...
                if (user) {
                    return {
                        ...
                        recentDeduction: (deductions === null || deductions === void 0 ? void 0 : deductions.deductions) ? deductions.deductions : [],
                    };
                }
    ...
    updateBadge() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const badges = yield badgeModel_1.default.find({}).sort({ minScore: -1 });
                if (badges.length === 0) {
                ...
                for (let lendScore = yield cursor.next(); lendScore != null; lendScore = yield cursor.next()) {
                    ...
                    if (qualifiedBadge) {
                        bulkOps.push({
                            updateOne: {
                                ...
                                update: { $set: { badgeId: new mongodb_1.ObjectId(qualifiedBadge._id) } },
                            },
                        });
                    }
                }
