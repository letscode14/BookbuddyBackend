...
const adminReposito0ry_1 = __importDefault(require("../repository/adminReposito0ry"));
...
const adminUseCase = new adminUseCases_1.default(repository, jwtToken, cloudinary, sendEmail, paymentService);
...
adminRouter.get('/user/list', adminAuth_1.adminAuthMiddleware, (req, res, next) => {
    controller.getAllusers(req, res, next);
});
adminRouter.patch('/user/block', adminAuth_1.adminAuthMiddleware, (req, res, next) => {
...
adminRouter.get('/post/reports', adminAuth_1.adminAuthMiddleware, (req, res, next) => {
    controller.getPostReports(req, res, next);
});
adminRouter.patch('/remove/report', adminAuth_1.adminAuthMiddleware, (req, res, next) => {
    controller.removeReport(req, res, next);
});
//badge
adminRouter.post('/create-badge', adminAuth_1.adminAuthMiddleware, formidable_1.fileParser, (req, res, next) => {
    controller.addBadge(req, res, next);
});
adminRouter.get('/single-badge', (req, res, next) => {
    controller.getSingleBadge(req, res, next);
});
adminRouter.patch('/edit-badge', adminAuth_1.adminAuthMiddleware, (req, res, next) => {
...
adminRouter.get('/get/post', adminAuth_1.adminAuthMiddleware, (req, res, next) => {
    controller.getPost(req, res, next);
});
adminRouter.patch('/remove/post', adminAuth_1.adminAuthMiddleware, (req, res, next) => {
