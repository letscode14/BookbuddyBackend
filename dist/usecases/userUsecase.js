...
class UserUseCase {
    constructor(iuserRepository, sendEmail, jwtToken, cloudinary, PaymentService) {
            ...
            try {
                ...
                if ('user' in data) {
                    ...
                    if (!result) {
                        ...
                        return Object.assign(Object.assign({ statusCode: 200, message: 'User registered SuccessFully' }, result), { accessToken,
                            refreshToken });
                    }
                }
                else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (emailExists) {
                    ...
                    redis_1.redis.set(`user:${emailExists._id}`, JSON.stringify(emailExists));
                    const accessToken = yield this.JwtToken.SignInAccessToken({
                        id: emailExists._id,
                    ...
                    const { _id, email, userName, isSubscribed, privacy, name, isGoogleSignUp, profile, } = emailExists;
                    return {
                        statusCode: 200,
                    ...
                    const { _id, email, userName, isSubscribed, privacy, name, isGoogleSignUp, } = savedUser;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (emailExists) {
                    ...
                    const isValid = yield this.iUserRepository.loginUser(emailExists.password, password);
                    if (isValid) {
                        redis_1.redis.set(`user:${emailExists._id}`, JSON.stringify(emailExists));
                        const accessToken = yield this.JwtToken.SignInAccessToken({
                            id: emailExists._id,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (Array.isArray(cloudRes)) {
                    ...
                    const post = yield this.iUserRepository.addPost(id, description, imageUrlArray, req);
                    if (post) {
                        return {
                            statusCode: 201,
    ...
    verifyEditEmail(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const token = yield this.JwtToken.SignUpActivationToken({ email: email }, code);
                if (sendEmail) {
                    return {
                        status: true,
                        statusCode: 200,
    ...
    editUserDetails(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (file) {
                    const cloudRes = yield this.Cloudinary.cloudinaryUpload(file);
                    const result = yield this.iUserRepository.updateUserDetails(req, cloudRes);
                    if (result) {
                        return {
                            statusCode: 200,
            ...
            try {
                ...
                if (file !== undefined) {
                    ...
                    if (Array.isArray(cloudRes)) {
                        ...
                        const response = yield this.iUserRepository.postReport(req, imageUrlArray);
                        if (response) {
                            return {
                                statusCode: 200,
                            ...
                            return {
                                statusCode: 409,
                                message: 'You have already reported on this wait until it get resolved',
                            };
                        }
                    }
                    else {
    ...
    getRequestBook(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const isSubscribed = yield this.iUserRepository.checkIsSubscribed(userId);
                if (!isSubscribed) {
                    return {
                        statusCode: 403,
    ...
    verifyPayment(orderId, paymentId, signature, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const isSuccess = yield this.Payments.verifyPaymentSignature(orderId, paymentId, signature);
                if (isSuccess) {
                    const result = (yield this.iUserRepository.makeUserSubscribed(userId, paymentId));
                    return {
                        statusCode: 200,
    ...
    addStory(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (cloudRes) {
                    const imageUrl = {
                        public_id: cloudRes === null || cloudRes === void 0 ? void 0 : cloudRes.public_id,
                        secure_url: cloudRes === null || cloudRes === void 0 ? void 0 : cloudRes.secure_url,
                    };
    ...
    makeStoryViewed(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.iUserRepository.makeStoryViewed(storyId, userId);
                if (result) {
    ...
    getBorrowedBooks(userId, pageNo) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.iUserRepository.getBorrowedBooks(userId, pageNo);
                if (result) {
                    return {
                        statusCode: 200,
                        result: result,
    ...
    getNotifications(userId, pageNo, unRead) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.iUserRepository.getNotifications(userId, pageNo, unRead);
                if (result) {
                    return {
                        statusCode: 200,
                        result: result,
    ...
    verifyChangePassEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (emailExists === null || emailExists === void 0 ? void 0 : emailExists.isGoogleSignUp) {
                    return {
                        statusCode: 401,
                ...
                const token = yield this.JwtToken.signChangePassTokenOtp(user, code, email);
                if (sendEmail && token) {
                    return {
                        status: true,
                        statusCode: 200,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('user' in result) {
                    ...
                    const token = yield this.JwtToken.signChangePassTokenOtp('', code, email);
                    if (sendEmail && token) {
                        return {
                            statusCode: 200,
                            message: 'Otp has resend to the email',
    ...
    submitNewPasswordBeforeLogin(password, token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('user' in user) {
                    const result = yield this.iUserRepository.changePassWord(password, user.user);
                    if (result) {
                        return {
                            statusCode: 200,
    ...
    searchUsers(pageNo, query, user) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.iUserRepository.searchUsers(query, pageNo, user);
                if (response) {
                    return {
                        statusCode: 200,
                        result: response,
    ...
    otpChangePassAfterLogin(userId, email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield this.iUserRepository.findByEmailAndUserId(userId, email);
                ...
                if (user) {
                    ...
                    const token = yield this.JwtToken.signChangePassTokenOtp(userId, code, user.email);
                    if (token && sendEmail) {
                        return {
                            statusCode: 200,
                            result: token,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('user' in result) {
                    ...
                    const token = yield this.JwtToken.signChangePassTokenOtp(userId, code, email);
                    if (sendEmail && token) {
                        return {
                            statusCode: 200,
                            message: 'Otp has resend to the email',
    ...
    checkOldPassword(userId, password) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.iUserRepository.checkOldPassword(password, userId);
                if (result) {
                    const email = result.email;
    ...
    verifyaddFundsPayment(orderId, paymentId, signature, userId, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const isSuccess = yield this.Payments.verifyPaymentSignature(orderId, paymentId, signature);
                if (isSuccess) {
                    const user = yield this.iUserRepository.updateCautionDeposit(userId, amount);
                    if (user) {
                        return {
                            statusCode: 200,
