...
class AdminUseCase {
    constructor(iAdminRepository, JwtToken, cloudinary, sendEmail, paymentService) {
    ...
    getPeriodTransactionStatistics(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.iAdminRepository.getPeriodTransactionStatistics(req);
                if (result) {
                    return {
                        statusCode: 200,
                        result: result,
    ...
    getPeriodRequestStatistics(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.iAdminRepository.getPeriodRequestStatistics(req);
                if (result) {
                    return {
                        statusCode: 200,
                        result: result,
    ...
    makeRefund(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let bookId;
                const lendedTransaction = yield this.iAdminRepository.getLendedSingleTransaction(lendId);
                const request = lendedTransaction === null || lendedTransaction === void 0 ? void 0 : lendedTransaction.requestId;
                bookId = request.book._id;
                if (lendedTransaction === null || lendedTransaction === void 0 ? void 0 : lendedTransaction.hasMadeRefund) {
                    return {
                        statusCode: 400,
                ...
                if (book && user) {
                    ...
                    console.log(price, user === null || user === void 0 ? void 0 : user.paymentId);
                    const response = yield this.paymentService.createRefund(user === null || user === void 0 ? void 0 : user.paymentId, price, `Refund for the book ${book.ID}`, user === null || user === void 0 ? void 0 : user._id);
                    if (response) {
                        ...
                        const reduce = yield this.iAdminRepository.reduceCautionDeposit(culpritId, Number(price), `Deducted for dispute for book ${book.bookName}`, lendId);
                        if (reduce) {
                            return {
                                statusCode: 200,
